...
{
    public class SSY_APPFRAME_ITEM_CFG
    {
        #region SSY_APPFRAME_ITEM_ID
        /// <summary>
        /// SSY_APPFRAME_ITEM_ID
        /// <summary>
        private object _sSY_APPFRAME_ITEM_ID = null;
        public object SSY_APPFRAME_ITEM_ID
        {
            get
            {
                return this._sSY_APPFRAME_ITEM_ID;
            }
            set
            {
                this._sSY_APPFRAME_ITEM_ID = value;
            }
        }
        #endregion
        ...
        /// ITEMIDEN
        /// <summary>
        private object _iTEMIDEN = null;
        public object ITEMIDEN
        {
            get
            {
                return this._iTEMIDEN;
            }
            set
            {
                this._iTEMIDEN = value;
            }
        }
        #endregion
