...
@Component({
  selector: 'app-sysmanager-entry',
  templateUrl: './sysmanager.entry.component.html',
  styleUrls: ['./sysmanager.entry.component.css'],
  animations: [
    trigger('menuState', [
...
export class SysmanagerEntryComponent implements OnInit {

  /************************* define  ********************************/
  state: string = 'inactive';                      //menu state
  groups: any[] = [];
  parmenuid: string = "800";
